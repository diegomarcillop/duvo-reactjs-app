                ...
                <div className="col-md-12">
                    <div className="card shadow mb-3">
                        ...
                        <div className="col-sm-12">
                               ...
                               <p className=" text-user">Es un conjunto de instrucciones o reglas definidas y no-ambiguas,
                               ...
                               <hr className="my-1"/>
                               <h6>La definición de un algoritmo debe describir tres partes:
                               </h6>
                               <div className="row  ">
                                    <div className="col-sm-8 central-div  ">
                                         <div>
                                              ...
                                              <button type="button"
                                                   ...
                                                   Entrada, proceso y salida</button>
                                         </div>
                                         <div>
                                              <button
                                                   className="form-control form-control-sm   btn btn-outline-success space">Entrada,
                                                   programación y salida</button>
 
                                         </div>
                                         <div>
                                              <button
                                                   className="form-control btn btn-outline-success space form-control-sm">Información,
                                                   proceso y salida</button>
 
                                         </div>
                                         <div>
                                              <button className="form-control btn btn-outline-success space form-control-sm">
                                                   Información, programación y salida</button>
