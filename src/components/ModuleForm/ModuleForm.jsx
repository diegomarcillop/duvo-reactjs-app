  ...
  return (
    <div className="container m-3">
      <div className="card card-body card-module central-content col-sm-10 ">
        ...
        <hr />
        <form
          action="/cursos/modulos/registrarModulo/{{this.id}}"
          method="POST"
        >
          <div className="form-row p- ">
            <div className="form-group col-md-12 ">
              ...
              <input
                type="text"
                className="form-control form-control-sm fuente-releway "
                id="inputEmail4"
                name="title"
                autofocus
                required
          ...
          <div className="form-row">
            <div className="form-group col-md-12  ">
              ...
              <div className="custom-file ">
                <input
                  type="file"
                  className="form-control-file fuente-releway "
          ...
          <div className="row">
            <div className="col-sm-2 mr-auto">
              <Link
                type="button"
                class="btn-dark btn btn-sm  btn-block"
                to="/course/index"
              >
            ...
            <div className="col-sm-3 ml-auto">
              <Link
                type="button"
                class="btn-succes btn btn-sm  btn-block"
                to="/course/index"
              >
                <i class="fas fa-cubes"></i> Crear Modulo
              </Link>
            </div>
          </div>
        </form>
