          ...
          <div className="card-body">
            <div className="row">
              <div className="form-group m-2">
                <h2>Objetivo</h2>
                <h5 className="text-user">
                  Evaluar el conocimiento adquirido durante el modulo [
                  <strong>Introducción a algoritmo</strong>]
                </h5>
              </div>
            </div>
            <hr />
            <div className="question">
              <h6 className="text-user">
                <strong>1.</strong>Representa la operación o conjunto de
            ...
            <div className="question">
              <h6 className="text-user">
                <strong>2.</strong>Llamado Falso lenguaje ya que es una
                descripción de alto nivel, compacta e informal de un lenguaje de
                programación real. ?
              </h6>
              <div className="answer text-user p-1">
                <div className="form-check ">
